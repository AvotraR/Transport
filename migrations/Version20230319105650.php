 ...
 */
final class Version20230319105650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billet (id INT AUTO_INCREMENT NOT NULL, destination_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, depart_id INT DEFAULT NULL, voiture_id INT DEFAULT NULL, date_reservation DATETIME NOT NULL, nom VARCHAR(20) NOT NULL, prenom VARCHAR(20) NOT NULL, telephone INT NOT NULL, cin INT NOT NULL, prix INT NOT NULL, quantite INT NOT NULL, place LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_1F034AF6816C6140 (destination_id), INDEX IDX_1F034AF6BCF5E72D (categorie_id), INDEX IDX_1F034AF6AE02FE4B (depart_id), INDEX IDX_1F034AF6181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, destination_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, numero VARCHAR(10) NOT NULL, place LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_E9E2810F816C6140 (destination_id), INDEX IDX_E9E2810FBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
